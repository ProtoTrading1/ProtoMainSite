...
// Curated current product imagery for the browse rail. These are only used
// when their product remains eligible, so a removed or unavailable choice
// naturally falls back to the normal current-image selection.
const CURATED_TILE_SKUS = {
  'Beads & jewellery making': '8650000017', // bright mixed silicon beads
};
...
// Exact codes from the September air-shipment bead intake. A shared numeric
// prefix is not enough: older products (including crucifixes) use 86110 too.
// When these eligible cards are present in Beads, they lead the range newest
// first without promoting unrelated historic stock.
const NEW_BEAD_SKUS = new Set([
  '8610460077', '8610460078',
  '8610800972', '8610800973', '8610800974', '8610800975', '8610800976', '8610800977', '8610800978', '8610800979',
  '8610800980', '8610800981', '8610800982', '8610800983', '8610800984', '8610800985', '8610800986', '8610800987', '8610800988', '8610800989',
  '8610800990', '8610800991', '8610800992', '8610800993', '8610800994', '8610800995', '8610800996', '8610800997', '8610800998', '8610800999',
  '8610801000', '8610801001', '8610801002', '8610801003', '8610801004', '8610801005', '8610801006', '8610801007', '8610801008', '8610801009',
  '8610880368', '8610880369',
  '8611000475', '8611000476', '8611000477', '8611000478', '8611000479', '8611000480', '8611000481', '8611000482', '8611000483', '8611000484',
  '8611000485', '8611000486', '8611010005', '8611010006', '8611010009', '8611010010', '8611010011', '8611010012', '8611010013', '8611010014',
  '8611010015', '8611010016', '8611010017', '8611010018', '8611010020', '8611010021', '8611010022', '8611010023', '8611010024', '8611010025',
  '8611010026', '8611010027', '8611010028', '8611010029', '8611010030', '8611010031', '8611010032', '8611010033', '8611010034', '8611010035',
  '8611010036', '8611010037', '8611010039',
]);
...
function newBeadRangeRank(product) {
  if (discoveryGroup(product) !== 'Beads & jewellery making') return 1;
  const sku = String(product?.sku || '').trim().toUpperCase();
  return NEW_BEAD_SKUS.has(sku) ? 0 : 1;
}
...
export function compareInstoreSearch(left, right, query) {
  ...
  if (!terms.length) {
    ...
    const newRangeDifference = newBeadRangeRank(left) - newBeadRangeRank(right);
    return rankDifference || newRangeDifference
      || (newBeadRangeRank(left) === 0
        ? compareProductCodes(right?.sku, left?.sku)
...
export function discoveryTiles(products) {
  ...
  const curatedTargetBySku = new Map(Object.entries(CURATED_TILE_SKUS)
    .map(([label, sku]) => [String(sku).trim().toUpperCase(), label]));
  ...
  for (const product of products || []) {
    ...
    const curatedLabel = curatedTargetBySku.get(String(product?.sku || '').trim().toUpperCase());
    if (curatedLabel) curated.set(curatedLabel, candidate);
  ...
  for (const [label, candidate] of curated) {
    const tile = tiles.get(label);
    if (tile) Object.assign(tile, candidate);
  }
