...
// These category visuals are decorative entry points, not a claim about the
// stock or appearance of a particular item. Keep each one semantically aligned
// with its label: the product grid remains the source of truth for individual
// images, prices, and availability.
