...
const GROUPS = [
  ...
  ['Jewellery', { terms: ['necklace', 'earring', 'ring'], exclude: ['jump', 'bead', 'pendant', 'charm', 'clasp', 'finding', 'keyring', 'carabina', 'chain', 'display', 'box', 'stand', 'card', 'tray'] }],
  ['Beads & jewellery making', { departments: ['string beads', 'bead metal parts', 'bead accessories', 'chain', 'wooden beads', 'beads seed acrylic'], terms: ['bead', 'chain', 'pendant', 'finding', 'locket'] }],
