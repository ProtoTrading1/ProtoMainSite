...
import { searchInstoreProducts, discoveryGroup, discoveryTiles, matchesInstoreSearch } from '../lib/instore-discovery.mjs';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (isIsolatedPreviewRequest(req)) {
      ...
      const filtered = searchInstoreProducts(allEligible, query).filter((product) => !category || discoveryGroup(product) === category);
