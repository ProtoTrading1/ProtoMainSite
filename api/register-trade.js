...
import {
  ...
  sendTradeReceivedEmail,
} from './_trade-emails.js';
...
export default async function handler(req, res) {
  ...
  const displayName = normalizedContactName || normalizedBusinessName || '';
  await sendTradeReceivedEmail(normalizedEmail, displayName);
  if (shouldApprove) {
    await sendTradeApprovedEmail(normalizedEmail, displayName);
  }
