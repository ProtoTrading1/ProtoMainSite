        ...
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#050505', padding: '24px' }}>
          <div style={{ maxWidth: '560px', width: '100%', background: '#111827', color: '#f8fafc', border: '1px solid #1f2937', borderRadius: '18px', padding: '28px', fontFamily: 'Inter, sans-serif', boxShadow: '0 18px 50px rgba(0,0,0,0.45)' }}>
            ...
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              <button onClick={this.handleRetry} style={{ padding: '12px 18px', background: '#e11d48', color: '#fff', border: 'none', borderRadius: '10px', fontWeight: '700', cursor: 'pointer' }}>
                Retry portal
              </button>
              <button onClick={() => window.location.reload()} style={{ padding: '12px 18px', background: '#1f2937', color: '#fff', border: '1px solid #334155', borderRadius: '10px', fontWeight: '600', cursor: 'pointer' }}>
                Refresh page
              </button>
            </div>
          </div>
