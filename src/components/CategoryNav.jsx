...
export default function CategoryNav({
  ...
  // Department names come from the much smaller taxonomy request and should
  // never be held hostage by the full catalogue/count calculation. Render the
  // complete tree immediately, then hydrate counts without replacing the menu.
  const visibleCategories = countsReady
  ...
  return (
    <div className="cat-nav">
      ...
      <ul className="cat-nav-list" role="list" aria-busy={!countsReady}>
        {visibleCategories.map((cat) => {
          ...
          const count = countsReady ? lookupProductCount(counts, [cat.id], cats) : null;
