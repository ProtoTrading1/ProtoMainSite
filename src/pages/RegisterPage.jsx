    ...
    <div className="lp-register-card">
            {done ? (
              <div className="lp-quiz-success">
                ...
                <p>
                  {instantAccess
                    ? <>Welcome back, {contactName.trim()}. Your trade account is live{customerCode ? ` (customer code ${customerCode})` : ''}.{standalone ? ' We’ll notify you as soon as the site is launched.' : ` Log in with ${email.trim()} to start ordering.`}</>
                    : <>Thank you, {contactName.trim()}. We’ll review your trade account application and contact you about access.</>}
                </p>
